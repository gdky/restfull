...
public class AddzyswsnjService implements IAddzyswsnjService {
	...
	@Override
	public Map<String, Object> addZyswsnjb(Map<String, Object> obj)
			throws Exception {
	...
	public Map<String, Object> getzyswsnjb(int page, int pageSize, int Jgid,
		...
		Map<String, Object> rs = addzyswsnjdao.getZyswsnjb(page, pageSize,
				Jgid, map);
		return rs;
	}
	...
	public Map<String, Object> getzyswsxm(int page, int pageSize, int Jgid,
		...
		Map<String, Object> rs = addzyswsnjdao.getZyswsxm(page, pageSize, Jgid,
				map);
		return rs;
	}
