...
public class ZshyNbbDao extends BaseJdbcDao{
	...
	public Map<String, Object> getSwsjgqktjb(HashMap<String, Object> map) {
		...
		sql.append("              ELSE ");
		sql.append("               0 ");
		sql.append("            END) hh_jgs, ");
		sql.append("        SUM(CASE ");
		sql.append("              WHEN jg.jgxz_dm = '2' THEN ");
		sql.append("               1 ");
		sql.append("              ELSE ");
		sql.append("               0 ");
		sql.append("            END) yx_jgs, ");
		sql.append("        SUM(CASE ");
